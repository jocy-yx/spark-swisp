...
import com.yx.DBSCANClustering.imis.Imis_GDBSCAN
...
object ImisTrajectoryETL {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Spark应用的基础配置
    val conf = new SparkConf().setAppName("ImisTrajectoryETL")
...
//    val m = 15
    ...
    val parsedLogRDD: RDD[TrajectoryData] = sc
      ...
      .flatMap(line => RawDataImisParser.parse(line,eps))//更改******************
