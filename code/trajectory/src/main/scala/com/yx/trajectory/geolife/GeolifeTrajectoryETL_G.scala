...
object GeolifeTrajectoryETL_G {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Spark应用的基础配置
    val conf = new SparkConf().setAppName("GeolifeTrajectoryETL_G")
    ...
    val dataTime = conf.get("spark.GeolifeTrajectoryETL_G.dataTime", "20021009")
