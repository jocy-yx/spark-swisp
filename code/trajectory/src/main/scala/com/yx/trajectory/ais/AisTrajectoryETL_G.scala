...
object AisTrajectoryETL_G {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Spark应用的基础配置
    val conf = new SparkConf().setAppName("AisTrajectoryETL_G")
    ...
    //数据集
//    val testTrajectoryRawInputPath = conf.get("spark.AisTrajectoryETL_G.testTrajectoryRawInputPath",
//      "E:\\data\\Ais\\ais_04.txt")
    ...
    val dataTime = conf.get("spark.AisTrajectoryETL_G.dataTime", "20170104")
