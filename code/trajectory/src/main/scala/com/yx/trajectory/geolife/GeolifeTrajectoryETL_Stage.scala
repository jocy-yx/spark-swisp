...
import com.yx.DBSCANClustering.geolife.GeoLife_GDBSCAN
...
object GeolifeTrajectoryETL_Stage {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Spark应用的基础配置
    val conf = new SparkConf().setAppName("GeolifeTrajectoryETL_Stage")
...
//    val OutputPath = conf.get("spark.GeolifeTrajectoryETL.OutputPath", "data/geolife/")
    ...
    val dataTime = conf.get("spark.GeolifeTrajectoryETL_Stage.dataTime", "20021009")
