package com.yx.DBSCANClustering.imis;
...
import com.yx.cellID.imis.ImisLifeGrid;
import org.apache.spark.SparkEnv;

import java.util.*;

public class Imis_GDBSCAN {
    ...
    // 构造方法2
    public Imis_GDBSCAN(double eps, int minPts, Point[] points) {
        this.eps = eps;
        this.minPts = minPts;
        for (Point p :points){
...
//        clusters.add(noisies);
    ...
    private ArrayList<String> getNeighbors(String point) {
        ...
        ImisLifeGrid imis_gdbscan = new ImisLifeGrid(eps);
        List<Long> closeIds = imis_gdbscan.closeId(rawData.get(point).getCellID());
