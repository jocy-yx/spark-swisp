package com.yx.cellID.trucksGeoUtils;

import java.util.ArrayList;
import java.util.List;

public class TrucksGrid {
  
    private double LON_EAST = 24.5;
  
    private double LON_WEST = 23.5;
   
    private double LAT_NORTH = 38.5;
    
    private double LAT_SOUTH = 37.5;
